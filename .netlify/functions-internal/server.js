...
// app/styles/app.css
var app_default = "/build/_assets/app-XZ6AU6RK.css";
...
function SearchBarForm({ totalBooks }) {
  let [params, setParams] = (0, import_react12.useSearchParams)(), [secondCats, setSecondCats] = (0, import_react13.useState)([]), navigate = (0, import_react12.useNavigate)(), submit = (0, import_react12.useSubmit)(), [ratingSortState, toggleRSState] = (0, import_react13.useReducer)(ratingReducer, "off"), formRef = (0, import_react13.useRef)(null), inputRef = (0, import_react13.useRef)(null), testRef = (0, import_react13.useRef)(null), catRef = (0, import_react13.useRef)(null), subCatRef = (0, import_react13.useRef)(null), [favoriteState, setFavoriteState] = (0, import_react13.useState)(!1), [isListenedTo, setIsListenedTo] = (0, import_react13.useState)(!1), newParams = (0, import_react13.useMemo)(
    () => ({
  ...
  }, [isListenedTo, favoriteState, ratingSortState]), (0, import_react13.useEffect)(() => {
    secondCatsFunc();
  ...
  let db_handleChange = import_lodash2.default.debounce((e) => handleChange(e), 400);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { className: "flex w-full  bg-cerulean-blue-400 p-4 mb-5", id: "form", children: /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(
    import_react12.Form,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { className: "flex  space-x-4 mr-4 ", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { className: "flex flex-col justify-around ", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(
              "input",
              {
                type: "hidden",
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { className: "search-form-input-label ml-0", children: "Rating Sort" }, void 0, !1, {
              fileName: "app/components/audiobooks/SearchBarForm.tsx",
              lineNumber: 336,
              columnNumber: 13
            }, this),
...
var filterBooksDB = async (userId, filter, sort, pagination) => {
  oo_oo(), console.log("SORT OPTS", sort, "b6dbf379_0");
...
var import_jsx_dev_runtime14 = require("react/jsx-dev-runtime"), loaderSchema = import_zod.z.object({
  ...
  oo_oo2(), console.log("in Loader Function", userId, "bf3e5eb1_0");
  ...
  return oo_oo2(), console.log("Values in Action", _action, values, "bf3e5eb1_1"), _action === "toggle-favorite" ? await updateUserBooksDB(userId, bookId, {
