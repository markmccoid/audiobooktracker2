...
async function getSingleBook(userId, bookId) {
  ...
  return delete mergedBook.userBooks, console.log("Merged Book", mergedBook), mergedBook;
}
var filterBooksDB = async (userId, filter, sort, pagination) => {
  ...
  return console.log("returning books filterBooksDB", slicedBooks.length), { slicedBooks, paginationOut };
};
...
async function destroyUserSession(request) {
  ...
  return console.log("DESTORY", session.get("userId")), (0, import_node.redirect)("/", {
    headers: {
...
function $bookid() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_jsx_dev_runtime5.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_react5.Link, { to: "../", className: "button", children: [
...
var loader2 = async ({ request, params }) => {
  ...
  return await getSingleBook(userId, params.bookId) || null;
};
...
function BookListenedTo({ book }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(fetcher.Form, { method: "post", children: [
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("div", { className: "flex text-xl font-semibold justify-around", children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(import_react11.Link, { to: `./${book.id}`, children: book.title }, void 0, !1, {
...
function BookId() {
  let book = (0, import_react12.useRouteLoaderData)("routes/audiobooks/$bookId");
  return oo_oo(), console.log("book data", book, "f149c215_0"), /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("div", { children: [
    "In OUTLET 1",
    /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(BookCard_default, { book }, void 0, !1, {
...
var import_react13 = require("@remix-run/react"), import_jsx_dev_runtime13 = require("react/jsx-dev-runtime");
function Edit() {
...
var import_react16 = require("@remix-run/react"), import_react17 = require("react"), import_lodash3 = __toESM(require("lodash")), import_ai3 = require("react-icons/ai"), import_bs2 = require("react-icons/bs"), import_bs3 = require("react-icons/bs");
...
var import_zod = require("zod"), import_jsx_dev_runtime18 = require("react/jsx-dev-runtime"), loaderSchema = import_zod.z.object({
  ...
  return console.log("Values in Action", _action, values), _action === "toggle-favorite" ? await updateUserBooksDB(userId, bookId, {
...
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime18.jsxDEV)("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime18.jsxDEV)(SearchBarForm_default, { categories, totalBooks }, void 0, !1, {
...
var import_node5 = require("@remix-run/node"), import_react21 = require("@remix-run/react");
...
var import_react23 = require("@remix-run/react"), import_react24 = require("react"), import_node6 = require("@remix-run/node");
...
var import_node8 = require("@remix-run/node"), import_react25 = require("@remix-run/react");
