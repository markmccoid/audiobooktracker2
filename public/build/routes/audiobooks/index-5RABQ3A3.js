...
function SearchInput({ ref, defaultValue, clearInputField }) {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
        AiOutlineCloseCircle,
        {
          ...
          onClick: (e) => {
            ;
            oo_oo(), console.log("in close circle", `59c881a4_0`);
...
function SearchBarForm({ categories, totalBooks }) {
  ...
  const testRef = (0, import_react8.useRef)(null);
...
//# sourceMappingURL=/build/routes/audiobooks/index-5RABQ3A3.js.map
