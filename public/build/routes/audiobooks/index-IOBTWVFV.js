...
function BookFavorite({ book }) {
  ...
  const favoriteFlag = isFaving ? !((_b = book == null ? void 0 : book.userBooks[0]) == null ? void 0 : _b.favorite) : (_c = book == null ? void 0 : book.userBooks[0]) == null ? void 0 : _c.favorite;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(fetcher.Form, { method: "post", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
      "input",
      {
        ...
        id: "favorite",
        name: "favorite",
        value: (_e = (_d = book == null ? void 0 : book.userBooks[0]) == null ? void 0 : _d.favorite) == null ? void 0 : _e.toString()
      },
      void 0,
      false,
      {
...
function BookListenedTo({ book }) {
  var _a, _b;
  const fetcher = useFetcher();
  const BookListenedTo2 = (_a = book == null ? void 0 : book.userBooks[0]) == null ? void 0 : _a.listenedTo;
  const settingItem = ((_b = fetcher == null ? void 0 : fetcher.submission) == null ? void 0 : _b.formData.get("bookid")) === book.id;
  const optimisticValue = settingItem ? !BookListenedTo2 : BookListenedTo2;
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex flex-col w-[375px] h-[475px] border border-black m-3 bg-cerulean-blue-200", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex bg-cerulean-blue-200", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex flex-col mt-2 ", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "text-md text-cerulean-blue-900 font-semibold ", children: book.genres.join(", ") }, void 0, false, {
          fileName: "app/components/audiobooks/BookCard.tsx",
          lineNumber: 60,
          columnNumber: 11
        }, this)
...
function Index() {
  ...
  ;
  oo_oo(), console.log("book index", books.length, `3557648d_3`);
...
//# sourceMappingURL=/build/routes/audiobooks/index-IOBTWVFV.js.map
