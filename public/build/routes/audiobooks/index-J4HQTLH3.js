...
function SearchInput({ defaultValue, label, name, submitForm }, ref) {
  ...
  const clearInternal = () => {
    ...
    if (internalRef.current && (internalRef == null ? void 0 : internalRef.current.value) !== "") {
      internalRef.current.value = "";
      submitForm();
    }
  };
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex flex-col ", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("label", { htmlFor: "title", className: "search-form-input-label", children: label }, void 0, false, {
...
function Index() {
  ...
  ;
  oo_oo(), console.log("book index", books.length, nextURL, `be1aa1e0_2`);
...
//# sourceMappingURL=/build/routes/audiobooks/index-J4HQTLH3.js.map
