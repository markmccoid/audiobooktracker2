...
function SearchBarForm({ categories, totalBooks }) {
  ...
  const clearInputField = (inputName) => {
    ...
    if (inputRef.current) {
      ...
      ;
      oo_oo(), console.log("inputref", (_b = inputRef.current) == null ? void 0 : _b.value, `492a8a47_0`);
    }
  };
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
                AiOutlineCloseCircle,
                {
                  ...
                  onClick: (e) => {
                    ;
                    oo_oo(), console.log("in close circle", `492a8a47_1`);
...
//# sourceMappingURL=/build/routes/audiobooks/index-ZOGLFGSR.js.map
