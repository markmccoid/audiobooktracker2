...
function createFetcherForm(fetchKey) {
  let FetcherForm = /* @__PURE__ */ React4.forwardRef((props, ref) => {
    return /* @__PURE__ */ React4.createElement(FormImpl2, _extends2({}, props, {
      ref,
      fetchKey
    }));
...
function useFetcher() {
  ...
  let [key] = React4.useState(() => String(++fetcherId));
  let [Form3] = React4.useState(() => createFetcherForm(key));
  let [load] = React4.useState(() => (href) => {
    transitionManager.send({
      type: "fetcher",
      href,
      key
  ...
  let fetcherWithComponents = React4.useMemo(() => ({
    Form: Form3,
    submit,
    load,
    ...fetcher
...
//# sourceMappingURL=/build/_shared/chunk-K5QHLV7Z.js.map
